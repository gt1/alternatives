...
#include <libmaus/alignment/SimpleLocalAligner.hpp>
...
{
	typedef libmaus::fm::BidirectionalDnaIndexImpCompactHuffmanWaveletTree index_type;
	...
	ReadContainer(
		...
		libmaus::fm::SampledISA<lf_type> const & rISA
...
static bool isABCOverlap(
        ::libmaus::lcs::OverlapOrientation::overlap_orientation const abo,
        ::libmaus::lcs::OverlapOrientation::overlap_orientation const aco,
        ::libmaus::lcs::OverlapOrientation::overlap_orientation const bco
        )
{
	return (
                // abc
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back  && // ab
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back  && // ac
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back     // bc
                )
                // Abc
                ||
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back && // Ab
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back && // Ac
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back     // bc
                )
                // aBc
                ||
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front && // aB
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back  && // ac
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back    // Bc
                )
                // ABc
                ||
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front  && // AB
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back && // Ac
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back    // Bc
                )
                // abC
                ...
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back  && // ab
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front && // aC
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front    // bC
                )
                // AbC
                ||
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back && // Ab
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front  && // AC
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front    // bC
                )
                // aBC
                ||
                (
                        abo==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front && // aB
                        aco==libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front && // aC
                        bco==libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front     // BC
                )
                // ABC
                ||
                (
...
struct OverlapEntry
{
	...
	OverlapEntry(
		libmaus::lcs::OverlapOrientation::overlap_orientation rorientation,
		uint64_t roverhang,
		int64_t rscore,
		uint64_t roverlap,
		uint64_t rtarget
	...
	libmaus::lcs::OverlapOrientation::overlap_orientation decodeOverlapOrientation(uint64_t const v)
	{
		switch ( v )
		{
			case libmaus::lcs::OverlapOrientation::overlap_cover_complete: return libmaus::lcs::OverlapOrientation::overlap_cover_complete;
			case libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front: return libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front;
			case libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back: return libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back;
			case libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front: return libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front;
			case libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back: return libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back;
			case libmaus::lcs::OverlapOrientation::overlap_a_covers_b:    return libmaus::lcs::OverlapOrientation::overlap_a_covers_b;
			case libmaus::lcs::OverlapOrientation::overlap_b_covers_a:    return libmaus::lcs::OverlapOrientation::overlap_b_covers_a;
			case libmaus::lcs::OverlapOrientation::overlap_ar_covers_b:   return libmaus::lcs::OverlapOrientation::overlap_ar_covers_b;
			case libmaus::lcs::OverlapOrientation::overlap_b_covers_ar:   return libmaus::lcs::OverlapOrientation::overlap_b_covers_ar;
			case libmaus::lcs::OverlapOrientation::overlap_a_complete_b:  return libmaus::lcs::OverlapOrientation::overlap_a_complete_b;
			case libmaus::lcs::OverlapOrientation::overlap_ar_complete_b: return libmaus::lcs::OverlapOrientation::overlap_ar_complete_b;
			default:
			{
				libmaus::exception::LibMausException lme;
				lme.getStream() << "cannot decode " << v << " as libmaus::lcs::OverlapOrientation::overlap_orientation" << std::endl;
				lme.finish();
				throw lme;
			}
		}
	...
	{
		libmaus::util::NumberSerialisation::serialiseNumber(out,static_cast<uint64_t>(orientation));
		libmaus::util::NumberSerialisation::serialiseNumber(out,static_cast<uint64_t>(overhang));
		libmaus::util::NumberSerialisation::serialiseSignedNumber(out,static_cast<uint64_t>(score));
		libmaus::util::NumberSerialisation::serialiseNumber(out,static_cast<uint64_t>(overlap));
		libmaus::util::NumberSerialisation::serialiseNumber(out,static_cast<uint64_t>(target));
	}
	OverlapEntry(std::istream & in)
	:
		orientation(decodeOverlapOrientation(libmaus::util::NumberSerialisation::deserialiseNumber(in))),
		overhang(libmaus::util::NumberSerialisation::deserialiseNumber(in)),
		score(libmaus::util::NumberSerialisation::deserialiseSignedNumber(in)),
		overlap(libmaus::util::NumberSerialisation::deserialiseNumber(in)),
		target(libmaus::util::NumberSerialisation::deserialiseNumber(in))
	{}
};
...
void loadEdges(std::map< uint64_t,std::vector<OverlapEntry> > & preedges, std::set<uint64_t> & dup, std::string const & primedgesname)
{
	...
	libmaus::aio::CheckedInputStream CIS(primedgesname);
	
	// number of source vertices
	uint64_t const numentries = libmaus::util::NumberSerialisation::deserialiseNumber(CIS);
	...
	for ( uint64_t i = 0; i < numentries; ++i )
	{
		...
		uint64_t const n = libmaus::util::NumberSerialisation::deserialiseNumber(CIS);
	...
	uint64_t const numdup = libmaus::util::NumberSerialisation::deserialiseNumber(CIS);
	for ( uint64_t i = 0; i < numdup; ++i )
		dup.insert(libmaus::util::NumberSerialisation::deserialiseNumber(CIS));
...
void saveEdges(std::map< uint64_t,std::vector<OverlapEntry> > const & preedges, std::set<uint64_t> const & dup, std::string const & primedgesname)
{
	...
	libmaus::aio::CheckedOutputStream COS(primedgesname);
	libmaus::util::NumberSerialisation::serialiseNumber(COS,preedges.size());
	for ( std::map< uint64_t,std::vector<OverlapEntry> >::const_iterator ita = preedges.begin(); ita != preedges.end(); ++ita )
	{
		libmaus::util::NumberSerialisation::serialiseNumber(COS,ita->first);
		libmaus::util::NumberSerialisation::serialiseNumber(COS,ita->second.size());
		for ( uint64_t i = 0; i < ita->second.size(); ++i )
			ita->second[i].serialise(COS);
	}
	libmaus::util::NumberSerialisation::serialiseNumber(COS,dup.size());
	for ( std::set<uint64_t>::const_iterator ita = dup.begin(); ita != dup.end(); ++ita )
		libmaus::util::NumberSerialisation::serialiseNumber(COS,*ita);
	std::cerr << "done." << std::endl;
}
...
struct EdgeSet : public CurEndBase
{
	...
	{
		return
			OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front
			||
			OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back;
	}
	...
	{
		return
			OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front
			||
			OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back;
	}
		...
		else
		{
			...
			switch ( forward.orientation )
			{
				case libmaus::lcs::OverlapOrientation::overlap_cover_complete:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_cover_complete;
				case libmaus::lcs::OverlapOrientation::overlap_a_covers_b:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_b_covers_a;
				case libmaus::lcs::OverlapOrientation::overlap_b_covers_a:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_covers_b;
				case libmaus::lcs::OverlapOrientation::overlap_ar_covers_b:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_b_covers_ar;
				case libmaus::lcs::OverlapOrientation::overlap_b_covers_ar:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_ar_covers_b;
				case libmaus::lcs::OverlapOrientation::overlap_a_complete_b:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_complete_b;
				case libmaus::lcs::OverlapOrientation::overlap_ar_complete_b:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_ar_complete_b;
				case libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back;
				case libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back;
				case libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_front;
				case libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back:
					return reverse.orientation == libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_front;
				default:
					return false;
			}
		}
	...
	)
	{
		...
		std::pair< std::vector< uint64_t >, std::vector< uint64_t > > SCCshift =
			libmaus::graph::StronglyConnectedComponents::strongConnectContract<uint64_t,libmaus::graph::IdentityTargetProjector>(
			...
			while ( componentunused.size() )
			{
				...
				for ( uint64_t zroot1 = 0; zroot1 < root1V.size(); ++zroot1 )
				{
					...
					std::pair< std::vector< uint64_t >, std::vector< uint64_t > > SCC =
						libmaus::graph::StronglyConnectedComponents::strongConnectContract<OverlapEntry,OverlapEntryTargetProjector>(
							subedges,root1
						);
					#endif
						...
						if ( SCC.second[i]-SCC.second[i-1] > 1 )
						{
							...
							if ( RC )
							{
								...
								
								{
									...
									libmaus::aio::CheckedOutputStream COS(dotfn.c_str());
	...
	std::pair<std::string,double> createLinearContig(std::vector<uint64_t> const & vertices, ReadContainer const & RC) const
	{
		...
		else
		{
			...
			{
				case cur_end_left:
					// std::cerr << "adding " << libmaus::fastx::reverseComplementUnmapped(RC.getRead(vertices[0])) << " to pile at offset " << 0 << " for vertex rc " << vertices[0] << std::endl;
					pile.add ( 0, libmaus::fastx::reverseComplementUnmapped(RC.getRead(vertices[0])) );
					break;
				case cur_end_right:
			...
			for ( uint64_t i = 1; i < vertices.size(); ++i )
			{
				...
				switch ( edge.orientation )
				{
					...
					case libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back:
					case libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back:
						// ostr << libmaus::fastx::reverseComplementUnmapped(RC.getRead(vertices[i])).substr(overlap,overhang);
						// std::cerr << "adding " << libmaus::fastx::reverseComplementUnmapped(RC.getRead(vertices[i])) << " to pile at offset " << offset << " for vertex rc " << vertices[i] << std::endl;
						pile.add(offset,libmaus::fastx::reverseComplementUnmapped(RC.getRead(vertices[i])));
		...
		for ( uint64_t componentid = 0 ; unused.size(); ++componentid )
		{
			...
			for ( uint64_t root1Vi = 0; root1Vi < root1V.size(); ++root1Vi )
			{
				...
				if ( vertsetsseen.find(flipLowBit(vertset)) == vertsetsseen.end() )
				{
					...
					std::pair<bool,std::map<uint64_t,uint64_t> > const TS = libmaus::graph::TopologicalSorting::topologicalSorting(
						subedges,
						computeId(root),
						libmaus::graph::IdentityTargetProjector()
					);
					...
					if ( TS.first )
					{
						...
						if ( RC )
						{
							...
							while ( plow != allpaths.size() )
							{
								...
								libmaus::aio::CheckedOutputStream COS(fnostr.str());
			...
			)
			{
				...
				)
				{
					...
					std::pair<bool,std::map<uint64_t,uint64_t> > TS = 
						libmaus::graph::TopologicalSorting::topologicalSorting<uint64_t,libmaus::graph::IdentityTargetProjector>(
							subedgesshift,computeId(curvert,cur_end),libmaus::graph::IdentityTargetProjector()
						);
					...
					#if 0
					std::pair<bool,std::map<uint64_t,uint64_t> > TS = 
						libmaus::graph::TopologicalSorting::topologicalSorting<OverlapEntry,OverlapEntryTargetProjector>(
			...
			switch ( cur_end )
			{
				case cur_end_left:
					if ( countLeftEdges(v) == 1 )
					{
						...
						if ( OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_front_dovetail_b_back )
						{
				...
				case cur_end_right:
					if ( countRightEdges(v) == 1 )
					{
						...
						// edge ends on the right side of the other read
						if ( OE.orientation == libmaus::lcs::OverlapOrientation::overlap_a_back_dovetail_b_back )
						{
							// check that following read has only one outgoing edge in direction and it leads us back to v
							if ( 
								countRightEdges(OE.target) == 1 
...
int main(int argc, char * argv[])
{
	try
	{
		...
		std::string const isaname = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt") + ".isa";
		std::string const primedgesname = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt") + ".primedges";
		std::string const cleanededgesname = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt") + ".cleanededges";
		std::string const straightcontigsfa = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt") + "_straight_contigs.fa";
		std::string const straightcontigsfq = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt") + "_straight_contigs.fq";
		std::string const prefix = libmaus::util::OutputFileNameTools::clipOff(hwtname,".hwt");
		...
		libmaus::fm::BidirectionalDnaIndexImpCompactHuffmanWaveletTree index(hwtname);
		typedef libmaus::fm::BidirectionalDnaIndexImpCompactHuffmanWaveletTree::lf_type lf_type;
		libmaus::fm::SampledISA<lf_type>::unique_ptr_type const pISA(libmaus::fm::SampledISA<lf_type>::load(index.LF.get(),isaname));
		libmaus::fm::SampledISA<lf_type> const & ISA = *pISA;
		...
		if ( 1 < arginfo.restargs.size() )
		{
			...
			libmaus::aio::PosixFdInputStream readsCIS(readsname);
			libmaus::lz::PlainOrGzipStream readsPOGS(readsCIS);
			libmaus::fastx::StreamFastAReaderWrapper SFARW(readsPOGS);
		...
		libmaus::lcs::HammingOverlapDetection const HOD;		

		std::map< uint64_t,std::vector<OverlapEntry> > preedges;
		libmaus::parallel::PosixSpinLock preedgeslock;
		std::set<uint64_t> dup;
		libmaus::parallel::PosixSpinLock duplock;
		libmaus::parallel::PosixSpinLock cerrlock;

		if ( libmaus::util::GetFileSize::fileExists(cleanededgesname) )
		{
			loadEdges(preedges, dup, cleanededgesname);		
		}
		else
		{	
			if ( libmaus::util::GetFileSize::fileExists(primedgesname) )
			{
			...
			else
			{
				...
				for ( uint64_t readid = 0; readid < numreads; readid++ )
				{
					...
					for ( uint64_t i = 0; i < ref.size()-k+1; ++i )
					{
						...
						libmaus::fm::BidirectionalIndexInterval const bint = index.biSearchBackward(sub.begin(), k);
					...
					for ( std::set<uint64_t>::const_iterator ita = overlapcand.begin(); ita != overlapcand.end(); ++ita )
					{
						...
						libmaus::lcs::OverlapOrientation::overlap_orientation ori;
						uint64_t overhang = 0;
						int64_t maxscore = 0;
						...
						if ( ok && (maxscore >= static_cast<int64_t>(minreqscore)) )
						{
							if ( overhang == 0 )
							{
								...
								if ( readid > mseq )
								{
									libmaus::parallel::ScopePosixSpinLock llock(duplock);
									dup.insert(readid);
								}
							}
							else
					...
					if ( ! ledges.size() )
					{				
						libmaus::parallel::ScopePosixSpinLock lcerrlock(cerrlock);
						std::cerr << "no edges for " << uref << std::endl;
					}
					#endif
					
					{
					libmaus::parallel::ScopePosixSpinLock lpreedgeslock(preedgeslock);
			...
			libmaus::parallel::PosixSpinLock edgekilllock;
			#if defined(_OPENMP)
			...
			for ( uint64_t ia = 0; ia < keys.size(); ++ia )
			{
				...
				for ( uint64_t i = 0; i < aedges.size(); ++i )
				{
					...
					libmaus::lcs::OverlapOrientation::overlap_orientation aborientation = abedge.orientation;
					...
					for ( uint64_t j = i+1; j < aedges.size(); ++j )
						if ( ledgekill.find(j) == ledgekill.end() )
						{
							...
							libmaus::lcs::OverlapOrientation::overlap_orientation acorientation = aedges[j].orientation;
				...
				{
				libmaus::parallel::ScopePosixSpinLock ledgekilllock(edgekilllock);
		...
		{
		libmaus::aio::CheckedOutputStream COS(straightcontigsfa);
		...
		{
		libmaus::aio::CheckedOutputStream COS(straightcontigsfq);
		for ( uint64_t i = 0; i < straight.size(); ++i )
		{
			std::string const s = ES.createLinearContig(straight[i],RC).first;
			COS << "@contig_" << i << "_" << s.size() << "\n";
